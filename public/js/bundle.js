...
var stripe = Stripe('pk_test_V0rfzYVORTmkHIWIwq1Eger800b1i98xvO');
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(retreatId) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function bookRetreat(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookRetreat = bookRetreat;
...
var bookBtn = document.querySelector('.book-retreat');
var bookBtnTwo = document.querySelector('.book-retreat-2');
var bookBtnThree = document.querySelector('.book-retreat-3');
var bookBtnFour = document.querySelector('.book-retreat-4');
var bookBtnFive = document.querySelector('.book-retreat-5');
var bookBtnSix = document.querySelector('.book-retreat-6');
var bookBtnSeven = document.querySelector('.book-retreat-7');
var bookBtnEight = document.querySelector('.book-retreat-8'); // DELEGATION
